...
class listMapel3 extends React.Component {
    ...
    render() {
        ...
        if(pendidikan === 'SMK') {
            return (
                <select name="nama_mapel2" value={this.props.namaMapel2} className="form-control" onChange={this.props.valueChange2}>
