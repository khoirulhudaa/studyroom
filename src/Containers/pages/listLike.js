...
class listLike extends React.Component {
    ...
    render() {
        ...
        const {pendidikan, nama_mapel} = this.state;

        if(pendidikan === 'SMK') {
            return (
                <select name="nama_mapel" value={this.props.namaMapel} className="form-control" onChange={this.props.valueChange}>
